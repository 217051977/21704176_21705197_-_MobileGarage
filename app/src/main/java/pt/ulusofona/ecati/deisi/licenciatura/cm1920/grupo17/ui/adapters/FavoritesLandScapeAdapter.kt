...
class FavoritesLandScapeAdapter(
    ...
    class FavoritesLandScapeViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoritesLandScapeViewHolder {
        return FavoritesLandScapeViewHolder(
            LayoutInflater.from(
                context
            ).inflate(
                layout,
    ...
    override fun onBindViewHolder(holder: FavoritesLandScapeViewHolder, position: Int) {
    ...
    private fun setOnClickTreatment(holder: FavoritesLandScapeViewHolder, position: Int) {
